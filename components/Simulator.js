...
export default function Simulator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      {distance !== null && timeTaken !== null && (
            <div className="flex flex-col items-center text-center bg-sky-200 p-4 rounded-xl shadow-xl my-8">
                <h2 className="card-title text-black">Results</h2>
                <p className="text-black">Distance: {distance} units</p>
                <p className="text-black">Time Taken: {timeTaken.toFixed(2)} seconds</p>
            </div>
        )}
